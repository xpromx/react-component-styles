...
import { Button, ButtonSize, ButtonVariants } from "../components/Button-CSSM-TW/Button";
...
const Page: NextPage = () => {
  return (
    <div className="p-10">
      <h1 className="text-4xl text-black w-full mb-10">CSS Modules + Tailwind CSS</h1>
